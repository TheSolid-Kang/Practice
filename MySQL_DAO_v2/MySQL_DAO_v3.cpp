#include "pch.h"
#include "MySQL_DAO_v3.h"

std::unique_ptr<sql::ResultSet> MySQL_DAO_v3::GetResultSet(const TString& _query) {
...
std::vector<std::vector<TString>> MySQL_DAO_v3::GetDataContainer(const TString& _query, int _column_cnt) {
...
void MySQL_DAO_v3::Execute(const TString& _query)
{
	sql::Driver* driver = nullptr;
	sql::Connection* con = nullptr;
	sql::Statement* stmt = nullptr;
...
bool MySQL_DAO_v3::ExecuteTransaction(std::vector<TString> _vec_query)
{
